...
@Route(value = "policy")
@PermitAll
public class ChangePolicy extends AppLayout {
    ...
    private void setHeader(){
        ...
        HorizontalLayout header = new HorizontalLayout(toggle, title,img,  logout);
    ...
    private void setPage(){
        ...
        pageTitle  = new H1("Adjust chosen policies!");
